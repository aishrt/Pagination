...
Only 9 items are rendered through backend on task list page , if more then 9 blogs are added pagination will automatically start.


If you try to go to invalid usrl it will shows an error msg , with refresh otion to redirect to landing page


Steps to install and run project :

1-> Clone the repository: git clone https://github.com/aishrt/taskApp.git
